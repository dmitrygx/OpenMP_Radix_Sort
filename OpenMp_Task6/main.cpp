...
int main(int argc, char **argv)
{
  ...
  OmpOutput(true, "omp_array.txt", "Source array:", array, num);
  time_t start = clock();
  result = OmpRadixSortMSD(array, num, precision, 1);
  time_t end = clock(); 
  ...
  OmpOutput(true, "omp_result.txt", "Result of array sorting:", result, num);
